					...
					<div class="card shadow" style="padding: 25px;">
						...
						<div class="review_list">
							<div style="text-align: left;">
								<form name="sasub" action="studyanswerupdateres.do" method="post">
									...
									<div align="left">
										...
										<div align="left" class="content" style="resize: none;">
											<p>
												<textarea rows="10" name="racontent" style="resize: none; border-color: white; width: 100%;">${radto.racontent }</textarea>
											</p>
										</div>
									</div>
									<div>
										<input class="text-btn" type="button" onclick="update()" value="수정" style="float: right; margin-top: -5px; font-size: 15px">
										<input class="text-btn" type="button" value="취소" onclick="cancel(${radto.rbseq})" style="float: right; margin-top: -5px; font-size: 15px">
									</div>
								</form>
							</div>
						</div>
