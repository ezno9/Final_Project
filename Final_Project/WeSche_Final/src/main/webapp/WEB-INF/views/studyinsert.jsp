         ...
         <div class="row">
            <div class="col">
               <div class="card shadow">
                     <form name="sub1" action="studyinsertres.do" method="post">
                  ...
                  <table>
                        ...
                        <div style="margin: 0 20px 8px 20px;">
                           <div class="study-insert" style="border-top: 1px solid #CCCCCC; padding-top: 8px; " >
                              ...
                              <select name="tag" id="tag" style="padding: 6px; border-radius:0.375rem; border: 1px solid #CCCCCC; float:right;">
                           ...
                           <div style="padding-top: 8px;  text-align: center;">
                              <textarea class="autosize" onkeydown="resize(this)" onkeyup="resize(this)" name="rbcontent" id="rbcontent" style="resize: none; width:100%; border-radius:0.375rem; height: 400px; border: 1px solid #CCCCCC;"placeholder="내용을 입력해 주세요."></textarea>
                           </div>
