...
var userid = "<%=userid%>";
   ...
   function deleteRoom(myno,chat_list_no,pagelength){
        ...
        if (willDelete) {
          swal("채팅방을 삭제하셨습니다!", {
            icon: "success",
             ...
             location.href="returnroomq.do?myno="+myno+"&chat_list_no=" +chat_list_no+"&pagelength="+pagelength;
          });
        } else {
				...
				<div class="col">
					<div class="card shadow">
						<div class="text-center">
							<button type="button" id="inviteBtn" class="btn btn-primary my-4">대화방 초대</button>
							<button type="button" class="btn btn-primary my-4" onclick="deleteRoom(${bdto.qbseq},${cdto.chat_list_no },${pagelength });">대화방 삭제</button>
										...
										<c:otherwise>
											<c:forEach items="${invitelist }" var="invitedto">
												...
												<li class="input-group input-group-alternative mb-3">
													...
													<p class="form-control">${invitedto.qamemberid }</p>
													<input type="checkbox" name="invitelist" value="${invitedto.qamemberid }">
												</li>
